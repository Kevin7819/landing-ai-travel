export default function Roadmap() {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-bl from-purple-50 via-white to-blue-50">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <div className="inline-flex items-center gap-1.5 sm:gap-2 bg-white border border-gray-200 rounded-full px-3 sm:px-4 py-1.5 sm:py-2 mb-3 sm:mb-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {phases.map((item, index) => (
            <div key={index} className="group">
              <div className={`${item.color} text-white p-4 sm:p-5 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105 h-full flex flex-col`}>
                ...
                <div className="flex-1">
                  ...
                  {/* Status badge */}
                  <div className="inline-flex items-center gap-1 bg-white/20 backdrop-blur-sm px-2 py-1 rounded-full text-xs font-medium mb-2">
